...
Por otro lado Ripley y Falabella tienen un set de televisores a ofertar, es como si aún en un ecommerce cuidaran el $m^2$ digital.  
...
### Hay productos, principalmente en Linio, que no son televisores, pero están en esta sección. Hay que remover estos items.
...
### Comparativo año a año de la cantidad de TVs en cada Ecommerce
...
### No usar título porque no entra en los límites del formato de la página web. 
